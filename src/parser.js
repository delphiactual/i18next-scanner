        ...
        lngs.forEach((lng) => {
            ...
            Object.keys(keys).forEach((index) => {
                ...
                if (containsPlural) {
                    ...
                    if (containsContext && containsPlural) {
                        suffixes.forEach((pluralSuffix) => {
                            contextValues.forEach(contextValue => {
                                resKeys.push(`${key}${contextList?.[options.contextList]?.separator ?? contextSeparator}${contextValue}${pluralSuffix}`);
                            });
                        });
                    }
                } else {
                    ...
                    if (containsContext) {
                        contextValues.forEach(contextValue => {
                            resKeys.push(`${key}${contextList?.[options.contextList]?.separator ?? contextSeparator}${contextValue}`);
                        });
                    }
                }
