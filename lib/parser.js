...
var _ensureArray2 = _interopRequireDefault(require("ensure-array"));
    ...
    value: function set(key) {
      ...
      lngs.forEach(function (lng) {
        ...
        Object.keys(keys).forEach(function (index) {
          var _contextList$options$3, _contextList$options$4, _contextList$options$5, _contextList$options$6;
          ...
          var contextValues = function () {
            ...
            if (((_ensureArray = (0, _ensureArray2["default"])(contextList === null || contextList === void 0 ? void 0 : (_contextList$options$ = contextList[options.contextList]) === null || _contextList$options$ === void 0 ? void 0 : _contextList$options$.list)) === null || _ensureArray === void 0 ? void 0 : _ensureArray.length) > 0) {
              var _contextList$options$2;

              return (0, _ensureArray2["default"])((_contextList$options$2 = contextList[options.contextList]) === null || _contextList$options$2 === void 0 ? void 0 : _contextList$options$2.list);
            }

            if ((0, _ensureArray2["default"])(contextDefaultValues).length > 0) {
              return (0, _ensureArray2["default"])(contextDefaultValues);
            }

            return [];
          }();

          var contextListSeparator = ((_contextList$options$3 = contextList === null || contextList === void 0 ? void 0 : (_contextList$options$4 = contextList[options.contextList]) === null || _contextList$options$4 === void 0 ? void 0 : _contextList$options$4.separator) !== null && _contextList$options$3 !== void 0 ? _contextList$options$3 : contextSeparator) ? contextSeparator : '';
          var contextListFallback = (_contextList$options$5 = contextList === null || contextList === void 0 ? void 0 : (_contextList$options$6 = contextList[options.contextList]) === null || _contextList$options$6 === void 0 ? void 0 : _contextList$options$6.fallback) !== null && _contextList$options$5 !== void 0 ? _contextList$options$5 : contextFallback;
