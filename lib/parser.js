    ...
    value: function set(key) {
      ...
      lngs.forEach(function (lng) {
        ...
        Object.keys(keys).forEach(function (index) {
          ...
          var cntxtSeparator = (_contextList$options$3 = contextList === null || contextList === void 0 ? void 0 : (_contextList$options$4 = contextList[options.contextList]) === null || _contextList$options$4 === void 0 ? void 0 : _contextList$options$4.separator) !== null && _contextList$options$3 !== void 0 ? _contextList$options$3 : contextSeparator;
          ...
          if (containsPlural) {
            ...
            if (containsContext && containsPlural) {
              suffixes.forEach(function (pluralSuffix) {
                contextValues.forEach(function (contextValue) {
                  resKeys.push("".concat(key).concat(cntxtSeparator).concat(contextValue).concat(pluralSuffix));
                });
              });
            }
          } else {
            ...
            if (containsContext) {
              contextValues.forEach(function (contextValue) {
                resKeys.push("".concat(key).concat(cntxtSeparator).concat(contextValue));
              });
            }
          }
