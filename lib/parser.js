...
var _ensureArray3 = _interopRequireDefault(require("ensure-array"));

var _esprima = require("esprima");

var _lodash = _interopRequireDefault(require("lodash"));

var _acornOptionalChaining = _interopRequireDefault(require("acorn-optional-chaining"));
...
var Parser = /*#__PURE__*/function () {
  ...
  function Parser(options) {
    ...
    lngs.forEach(function (lng) {
      ...
      _this.pluralSuffixes[lng] = (0, _ensureArray3["default"])(getPluralSuffixes(lng, _this.options.pluralSeparator));
  ...
  _createClass(Parser, [{
    ...
    value: function parseFuncFromString(content) {
      ...
      var funcs = opts.list !== undefined ? (0, _ensureArray3["default"])(opts.list) : (0, _ensureArray3["default"])(this.options.func.list);
      ...
      var _loop = function _loop() {
        ...
        if (endsWithComma) {
          ...
          try {
            ...
            var supportedOptions = ['defaultValue', 'defaultValue_plural', 'count', 'context', 'contextList', 'ns', 'keySeparator', 'nsSeparator'];
    ...
    value: function parseTransFromString(content) {
      ...
      var parseJSXElement = function parseJSXElement(node) {
        ...
        (0, _ensureArray3["default"])(node.openingElement.attributes).forEach(function (attribute) {
        ...
        (0, _ensureArray3["default"])(node.children).forEach(function (childNode) {
        ...
        var attr = (0, _ensureArray3["default"])(node.openingElement.attributes).reduce(function (acc, attribute) {
          ...
          if (attribute.value.type === 'Literal') {
            ...
            if (expression.type === 'ObjectExpression') {
              var properties = (0, _ensureArray3["default"])(expression.properties);
      ...
      try {
        var ast = acorn.Parser.extend(_acornStage["default"], _acornOptionalChaining["default"], (0, _acornJsx["default"])()).parse(content, _objectSpread(_objectSpread({}, defaults.trans.acorn), acornOptions));
    ...
    value: function parseAttrFromString(content) {
      ...
      var attrs = opts.list !== undefined ? (0, _ensureArray3["default"])(opts.list) : (0, _ensureArray3["default"])(this.options.attr.list);
    ...
    value: function set(key) {
      ...
      var _this$options = this.options,
          ...
          contextList = _this$options.contextList,
      ...
      lngs.forEach(function (lng) {
        ...
        Object.keys(keys).forEach(function (index) {
          var _validContextList$sep, _validContextList$fal;
          ...
          var containsContext = function () {
            var _ensureArray, _contextList$options$;

            if (((_ensureArray = (0, _ensureArray3["default"])(contextList === null || contextList === void 0 ? void 0 : (_contextList$options$ = contextList[options.contextList]) === null || _contextList$options$ === void 0 ? void 0 : _contextList$options$.list)) === null || _ensureArray === void 0 ? void 0 : _ensureArray.length) > 0) {
              return true;
            }
          ...
          var contextValues = function () {
            var _ensureArray2, _contextList$options$2;

            if (((_ensureArray2 = (0, _ensureArray3["default"])(contextList === null || contextList === void 0 ? void 0 : (_contextList$options$2 = contextList[options.contextList]) === null || _contextList$options$2 === void 0 ? void 0 : _contextList$options$2.list)) === null || _ensureArray2 === void 0 ? void 0 : _ensureArray2.length) > 0) {
              var _contextList$options$3;

              return (0, _ensureArray3["default"])((_contextList$options$3 = contextList[options.contextList]) === null || _contextList$options$3 === void 0 ? void 0 : _contextList$options$3.list);
            }
            ...
            if ((0, _ensureArray3["default"])(contextDefaultValues).length > 0) {
              return (0, _ensureArray3["default"])(contextDefaultValues);
            }

            return [];
          }();

          var validContextList = contextList === null || contextList === void 0 ? void 0 : contextList[options.contextList];
          var contextListSeparator = ((_validContextList$sep = validContextList === null || validContextList === void 0 ? void 0 : validContextList.separator) !== null && _validContextList$sep !== void 0 ? _validContextList$sep : contextSeparator) ? contextSeparator : '';
          var contextListFallback = (_validContextList$fal = validContextList === null || validContextList === void 0 ? void 0 : validContextList.fallback) !== null && _validContextList$fal !== void 0 ? _validContextList$fal : contextFallback;
            ...
            if (containsContext && containsPlural) {
              suffixes.forEach(function (pluralSuffix) {
                contextValues.forEach(function (contextValue) {
                  resKeys.push("".concat(key).concat(contextListSeparator).concat(contextValue).concat(pluralSuffix));
                });
              });
            }
          } else {
            if (!containsContext || containsContext && contextListFallback) {
              resKeys.push(key);
            }

            if (containsContext) {
              contextValues.forEach(function (contextValue) {
                resKeys.push("".concat(key).concat(contextListSeparator).concat(contextValue));
              });
            }
          }
